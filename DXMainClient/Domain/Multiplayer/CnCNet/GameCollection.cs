...
namespace DTAClient.Domain.Multiplayer.CnCNet
{
    ...
    public class GameCollection
    {
        ...
        public void Initialize()
        {
            ...
            using Stream prIconStream = assembly.GetManifestResourceStream("DTAClient.Icons.pricon.png");
            ...
            using var prIcon = Image.Load(prIconStream);
            ...
            CnCNetGame[] defaultGames =
            {
                new()
                {
                    ...
                    UIName = "Project Rush: Conquer".L10N("Client:ClientCore:ProjectRushConquer"),
