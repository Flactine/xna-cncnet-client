...
namespace ClientCore
{
    public class ClientConfiguration
    {
        ...
        public string LongGameName => clientDefinitionsIni.GetStringValue(SETTINGS, "LongGameName", "Tiberian Sun")
            .L10N("INI:ClientDefinitions:LongGameName");
        ...
        /// <summary>
        /// ´Ó ClientDefinitions.ini µÄ [DateBasedMixes] ½Ú½âÎöÈÕÆÚ Mix ÅäÖÃ¡£
        /// ¸ñÊ½£ºEventName=MM-DD~MM-DD,source,target »ò EventName=MM-DD,source,target
        /// </summary>
        ...
        /// Must exceed <see cref="V3PingsPerTunnel"/> Ã— <see cref="V3PingTimeoutMs"/>, or a tunnel
        ...
        /// is judged against the relay it must beat â€” one lost probe out of four reads as 25% loss
        ...
        /// copy costs the pair its direct connection for the whole round â€” the peer gives up
        ...
        /// without either being able to detect it. Costs nothing but a slightly later teardown â€”
        ...
        /// so a single dead candidate cannot hold the round to the ping-phase timeout â€” at the
        ...
        /// interval â€” long enough for matchmaking to drop it from the shortlist and never try it.
